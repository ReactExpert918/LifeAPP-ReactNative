...
class Connectivity: NSObject {
	...
	override init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(reachabilityChanged(_:)), name: NSNotification.Name(rawValue: notification.rawValue), object: nil)
	}
