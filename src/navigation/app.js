    ...
    return(
        <>
            ...
            >
                ...
                <Stack.Screen name={APP_NAVIGATION.friend_search} component={FriendSearchScreen} />
                <Stack.Screen name={APP_NAVIGATION.friend_qrcode} component={FriendQRcodeScreen} />
            </Stack.Navigator>
        </>
    )
};
